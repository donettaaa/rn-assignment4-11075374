...
const popularJob = [
  ...
  {
    id: '11',
    logo: require('../assets/google.webp'),
    jobTitle: 'Data Scientist',
  ...
  {
    id: '12',
    logo: require('../assets/amazon.webp'),
    jobTitle: 'Software Engineer',
  ...
  {
    id: '14',
    logo: require('../assets/broadcom.png'),
  ...
  {
    id: '16',
    logo: require('../assets/qualcomm.png'),
      ...
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          <View style={styles.profileLeft}>
            <Text style={{ fontWeight: 'bold', fontSize: 24 }}>Donetta Selinam Dodoh</Text>
            <Text style={{ fontSize: 20, color: '#95969D' }}>selinamdonetta123@gmail.com</Text>
          </View>
        ...
        <View style={styles.searchContainer}>
          <View style={styles.searchLeft}>
            <SearchBar placeholder="Look for a job or position" />
          </View>
